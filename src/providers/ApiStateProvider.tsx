...
export const ApiStateContext: Context<ApiStateContextProps> = React.createContext({} as unknown as ApiStateContextProps)

export const ApiStateProvider = React.memo(({ children }: { children: React.ReactNode }): React.ReactElement => {
